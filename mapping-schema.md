...
* html template sections to the source object collections that drive instantion and contnt filling of the section templates.
...
or more elementFills. The dashed flows show how merger interprets the mapping to perform reads on datasources, and changes to the html.
...
| collections[] | |
|:-------------|:--|
| Object Description | Array of collection objects, each collection maps to one data source object array, and one target html section template. |
| dataSrcJpath | jsonPath expression to find the required registered data source array in dataSources. Each object in the source array drives the creation and filling of an instance of the section template. |
...
| startDataSrcJpath"| jsonPath within Data Sources, to variable used to indicate start index into source object array |
