...
| :---- | :---- |
| Object Description | Required, contains: zero or one (child) collections array, zero or one elementFills array. Note: collections can contain collections to handle the hierarchical nature of html. The elementFills array maps content from each source object to its corresponding instance of the section template.
