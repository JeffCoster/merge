...
*/
var merger_functions_js_1 = require("./merger-functions.js");
exports.extFunctions = {
        ...
        switch (functionSel) {
            ...
            default:
                ...
                if (this.customFunctions != undefined) {
                    ...
                    merger_functions_js_1.dbgConsole.warn("No standard function found for selector:"
